        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          >
            ...
            <div className="flex flex-col items-center gap-4 pt-4 lg:items-start">
              ...
              <Link
                href="#services"
                className="group inline-flex items-center justify-center gap-2 rounded-xl border-2 border-gray-200 bg-white px-6 py-3 font-semibold text-gray-700 transition-all duration-300 hover:border-primary hover:bg-primary/5 hover:text-primary sm:px-8 sm:py-3.5"
              >
